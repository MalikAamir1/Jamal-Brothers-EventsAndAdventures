      ...
      <ScrollView style={{flexGrow: 1, flex: 1, backgroundColor: 'white'}}>
        <View style={{flex: 1, backgroundColor: '#FFF'}}>
          ...
          <View
            ...
            <View style={{borderColor: 'rgba(246, 246, 246, 0.5)', width: '90%', height: 1, borderWidth: 1, marginTop: 25, marginBottom: 0, marginRight: 'auto',
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        <Text style={{color: '#D43D1C', fontWeight: 500, lineHeight: 20,
                          letterSpacing: -0.446,}}>
                          {' '}
                    ...
                    <>
                      ...
                      <View style={{marginHorizontal: 12, marginVertical: 10}}>
                        ...
                        <View
                          ...
                          <Text style={{color: '#707070', fontSize: 14, fontWeight: 500, lineHeight: 20,
letterSpacing: -0.446}}>
