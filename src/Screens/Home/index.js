...
import {View, StyleSheet, Text, Pressable, Image, FlatList, Platform} from 'react-native';
  ...
  return (
    <>
      <ModalView
        ...
        icon={'yes'}
      />
      <View style={{flex: 1, backgroundColor: '#FFF', paddingBottom: Platform.OS == 'ios' ? 100 : 30}}>
        {/* Header */}
