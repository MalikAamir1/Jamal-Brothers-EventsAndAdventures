...
export const Profile = ({route}) => {
  ...
  const data2 = [
    {
      image: require('../../Assets/Images/EAA/Events.png'),
    },
    {
      image: require('../../Assets/Images/EAA/Events.png'),
    },
  ...
  // const data2 = [
  //   {
  //     image: require('../../Assets/Images/EAA/image1.png'),
  //   },
  //   {
  //     image: require('../../Assets/Images/EAA/Sports.png'),
  //   },
  //   {
  //     image: require('../../Assets/Images/EAA/Events.png'),
  //   },
      ...
      <SafeArea>
        <ScrollView>
          <View
            ...
            <View style={{marginHorizontal: 20, marginTop: Platform.OS == 'ios' ? 0 : 20}}>
              <View>
                <Header
                  header={'My Profile'}
                  screenName={true}
              ...
              <View
                style={{
                  ...
                  ...Platform.select({
                    ...
                    android: {
                      shadowColor: 'rgba(242, 86, 75, 0.6)',
                      elevation: 32,
                    },
                  }),
                }}>
